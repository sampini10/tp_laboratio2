...
int employee_imprimirMap(void* pElemento)
{
	int retorno = -1;
    char auxiliarId[2048];
	char auxiliarNombre[2048];
	...
	if(pElemento != NULL)
	{
		employee_getHorasTrabajadasStr(pElemento,auxiliarHsTrabajadas);
		employee_getIdStr(pElemento,auxiliarId);
		employee_getNombre(pElemento,auxiliarNombre);
		employee_getSueldoStr(pElemento,auxiliarSueldo);
		printf("ID: %s | Nombre: %s | Sueldo: %s | Hs.Trabajadas: %s\n",auxiliarId,auxiliarNombre,auxiliarSueldo,auxiliarHsTrabajadas);
		retorno = 0;
	}
...
int employee_ajustesSueldo(void* pElemento)
{
	int retorno = -1;
	int auxiliarHs;
	Employee* auxiliarEmpleado;
	...
	{
		auxiliarEmpleado = (Employee*)pElemento;
		auxiliarHs = auxiliarEmpleado->horasTrabajadas;

		if(auxiliarEmpleado->horasTrabajadas >= 80)
		{
			auxiliarEmpleado->sueldo = auxiliarHs*500*20;
			retorno = 0;
		}
		else
		{
			auxiliarEmpleado->sueldo = auxiliarHs*300*20;
			retorno = 0;
		}
	}
...
int employee_obtenerHsMayores(void* pElemento)
{
	int retorno = -1;
	Employee* auxiliarEmpleado;
	...
	{
		auxiliarEmpleado = (Employee*)pElemento;
		if(auxiliarEmpleado->horasTrabajadas >= 100)
		{
			retorno = 1;
		}
		else
...
int employee_calcularSueldos(void* pElemento)
{
	int retorno = -1;
	Employee* auxiliarEmpleado;
	int auxiliarSueldo;
	...
	{
		auxiliarEmpleado = (Employee*)pElemento;
		auxiliarSueldo = auxiliarEmpleado->sueldo;
		retorno = auxiliarSueldo;
	}
