...
int controller_deleteLinkedList(LinkedList* pArrayListEmployee)
{
	...
	if(pArrayListEmployee != NULL)
	{
       ...
       {
    	   printf("\nLinkedList eliminada junto con nodos.\n");
    	   retorno = 0;
       }
	}
	return retorno;
...
int controller_push(LinkedList* pArrayListEmployee)
{
	...
	if(pArrayListEmployee != NULL)
	{
		auxiliarEmpleado = (void*)employee_newParametros(10,"nicolas",10,10);
		if(!ll_push(pArrayListEmployee,1,auxiliarEmpleado))
				{
			        printf("\nSe agrego elemento\n");
			        retorno = 0;
				}
...
int controller_pop(LinkedList* pArrayListEmployee)
{
    ...
    if(pArrayListEmployee != NULL)
    {
    	pElemento = ll_pop(pArrayListEmployee,0);
    	printf("\n Puntero del elemento %p",pElemento);
    	//employee_delete(pElemento);
    }
	return retorno;
}
int controller_containsAll(LinkedList* pArrayListEmployee,LinkedList* pArrayList2)
{
	...
	if(pArrayListEmployee != NULL && pArrayList2 != NULL)
	{
		if(ll_containsAll(pArrayListEmployee,pArrayList2)==1)
		{
			printf("\nElementos contenidos en ambas listas\n");
		}
		else
		{
			printf("\nElementos no contenidos en ambas listas\n");
		}
	}
...
LinkedList* controller_clone(LinkedList* pArrayListEmployee)
{
	...
	if(pArrayListEmployee != NULL)
	{
		subLista = ll_clone(pArrayListEmployee);
		printf("\nSe clono lista con exito\n");
